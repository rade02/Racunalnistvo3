public class Ulomek4 {
    public static void main(String[] args){
        ...
        System.out.println((stevilo == -1) ? ("Drugi je vecji od prvega"):((stevilo == 0) ? ("Sta enaka"):("Prvi je vecji od drugega")));
...
class Ulomek{
    ...
    public void pristej(Ulomek a, boolean izpisi){
    ...
    public void odstej(Ulomek a, boolean izpisi){
    ...
    public void zmnozi(Ulomek a, boolean izpisi){
        this.st *= a.st;
        this.im *= a.im;
        if(izpisi) System.out.println(this.st + "/" + this.im);
    }
    ...
    public void deli(Ulomek a, boolean izpisi){
        this.st *= a.im;
        this.im *= a.st;
        if(izpisi) System.out.println(this.st + "/" + this.im);
    }
